...
//         text: ' +213 6 67 62 82 88',
//     },
//     {
//         iconName: 'icofont-envelope ',
//         text: ' rafikblk@gmail.com',
//     },
// ]
...
//     {
//         iconName: 'icofont-twitter',
//         desc: <p>description<a href="#">@ShopCart Greetings</a> Grab your item, 50% Big Sale Offer !!</p>,
//     },
// ]
...
//                                             <p>{desc}</p>
//                                         </div>
//                                         <ul className='list-unstyled office-address'> 
//                                             {
...
const addressList = [
    ...
    {
        iconName: 'icofont-phone',
        text: '+213 6 67 6 82 88',
    },
    {
        iconName: 'icofont-envelope',
        text: 'rafik.boulkenafet@univ-constantine.dz',
    },
]
    ...
    <div className="footer-bottom">
        <div className="container">
            <div className="section-wrapper">
                <p>&copy; 2024 <Link to="/">Shop Cart</Link></p>
            </div>
        </div>
    </div>
</footer>
