              ...
              <div className="tabs mt-3">
                <ul className="nav nav-tabs" id="myTab" role="tablist">
                  <li className="nav-item" role="presentation">
                    ...
                    >
                      <img src="https://w7.pngwing.com/pngs/669/726/png-transparent-algiers-algerie-poste-mail-compte-cheque-postal-ooredoo-algeria-poste-blue-text-service-thumbnail.png" width="80" height="30"  />
                    </a>
                  </li>
                  <li className="nav-item" role="presentation">
                    <a
