                  ...
                  <div className="col-md-6 col-12">
                    <div className="calculate-shiping">
                      ...
                      <div className="outline-select shipping-select">
                        <select>
                        <option value="vol">Alger</option>
                          <option value="saab">Constantine</option>
                          <option value="saab">Jijel</option>
                          <option value="saab">Skikda</option>
                          <option value="saab">Oran</option>
